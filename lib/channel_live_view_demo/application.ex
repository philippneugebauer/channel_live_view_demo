defmodule ChannelLiveViewDemo.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ChannelLiveViewDemo.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ChannelLiveViewDemoWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
